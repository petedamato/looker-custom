(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["sparklines"] = factory();
	else
		root["sparklines"] = factory();
})(window, function() {
...
looker.plugins.visualizations.add({
  ...
  updateAsync: function updateAsync(data, element, config, queryResponse, details, done) {
    ...
    if (typeof config.where_values == 'undefined' || typeof config.where_chart == 'undefined') {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_3__('#vis').append(_error3);
    } else {
      try {
        var createTable = function createTable(data_insert, element) {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_3__["each"](headings_dim, function () {
            var found = false;
            var lookup_this = this; // this is the current heading
          ...
          var _loop = function _loop(i, len) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_3__["each"](headings_dim, function () {
              ...
              if (this == "chart_column") {
                ...
                var last_week_class;
                var direction_icon;
                var date_keys = Object.keys(data[i][measures[where_values[0]].name]);
          ...
          html += '</tbody>';
          html += '</table>';
          jquery__WEBPACK_IMPORTED_MODULE_3__('#vis').append(html);

          if (config.freeze_header == true) {
            jquery__WEBPACK_IMPORTED_MODULE_3__('th').addClass('stuck');
          } else {
            jquery__WEBPACK_IMPORTED_MODULE_3__('th').removeClass('stuck');
          }

          if (config.directionality == false) {
            jquery__WEBPACK_IMPORTED_MODULE_3__('.value-down').addClass('color-off');
            jquery__WEBPACK_IMPORTED_MODULE_3__('.value-up').addClass('color-off');
          } else {
            jquery__WEBPACK_IMPORTED_MODULE_3__('.value-down').removeClass('color-off');
            jquery__WEBPACK_IMPORTED_MODULE_3__('.value-up').removeClass('color-off');
          }
        };

        var drawOnTable = function drawOnTable(data_insert, element) {
          if (config.size_to_fit == true) {
            jquery__WEBPACK_IMPORTED_MODULE_3__("table").addClass("size-to-fit");
          } else {
            jquery__WEBPACK_IMPORTED_MODULE_3__("table").removeClass("size-to-fit");
          ...
          if (config.where_chart.length > 0) {
            var node_get_width = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "C"]("#chart_column-0");
          ...
          if (config.where_chart.length > 0) {
            var node_get_height = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "C"]("#chart_column-0");
          ...
          if (config.where_chart.length > 1) {
            var node_get_width_2 = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "C"]("#second_chart_column-0");
          ...
          if (config.where_chart.length > 1) {
            var node_get_height_2 = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "C"]("#second_chart_column-0");
          ...
          if (where_values.length < 1) {
            ...
            var _loop2 = function _loop2(j, len) {
              var dataset_one = [];
              var dataset_one_keys = Object.keys(data[j][measures[where_values[0]].name]);
              ...
              col_one_max = d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "r"]([col_one_max, d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "r"](dataset_one, function (ent) {
                return ent.value;
              })]);
              col_one_min = d3__WEBPACK_IMPORTED_MODULE_0__[/* min */ "s"]([col_one_min, d3__WEBPACK_IMPORTED_MODULE_0__[/* min */ "s"](dataset_one, function (ent) {
                return ent.value;
              })]);
              ...
              if (where_values.length > 1) {
                ...
                col_two_max = d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "r"]([col_two_max, d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "r"](dataset_two, function (ent) {
                  return ent.value;
                })]);
                col_two_min = d3__WEBPACK_IMPORTED_MODULE_0__[/* min */ "s"]([col_two_min, d3__WEBPACK_IMPORTED_MODULE_0__[/* min */ "s"](dataset_two, function (ent) {
                  return ent.value;
                })]);
              }
            };
            ...
            var _loop3 = function _loop3(i, _len) {
              ...
              var svg = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "C"](chart_id_grabber).append('svg').html('').attr('width', width_first).attr('height', height_first).classed('first-svg', true);
              ...
              icons = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "C"](triangle_id_grabber).append("svg").attr("width", 30).attr("height", 30).append("g").attr("transform", "translate(15,18)");
              var tri = icons.append('path').attr("d", d3__WEBPACK_IMPORTED_MODULE_0__[/* symbol */ "F"]().type(d3__WEBPACK_IMPORTED_MODULE_0__[/* symbolTriangle */ "G"]).size(30));
              ...
              if (config.first_chart_type == "line") {
                ...
                var xBar = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleBand */ "w"]().domain(dataset_one.map(function (d, i) {
                  return d.date;
              ...
              var arr_text = [];
              var val_extent = d3__WEBPACK_IMPORTED_MODULE_0__[/* extent */ "k"](dataset_one, function (d, i) {
                return d.value;
              });
              var maxValValues = {};
              var minValValues = {};
              ...
              if (where_values.length > 1) {
                ...
                var line2 = d3__WEBPACK_IMPORTED_MODULE_0__[/* line */ "q"]().defined(function (d) {
                  return d.value != null;
                }).x(function (d) {
                  return x(parseTime(d.date));
                }).y(function (d) {
                ...
                var area2 = d3__WEBPACK_IMPORTED_MODULE_0__[/* area */ "a"]().x(function (d) {
                  return x(parseTime(d.date));
                }).y0(function (d) {
                  return y2(0);
                }).y1(function (d) {
                ...
                var svg_two = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "C"](second_chart_id_grabber).append('svg').html('').attr('width', width_second).attr('height', height_second).classed('second-svg', true);
                ...
                icons_two = d3__WEBPACK_IMPORTED_MODULE_0__[/* select */ "C"](second_triangle_id_grabber).append("svg").attr("width", 30).attr("height", 30).append("g").attr("transform", "translate(15,18)");
                var tri_two = icons_two.append('path').attr("d", d3__WEBPACK_IMPORTED_MODULE_0__[/* symbol */ "F"]().type(d3__WEBPACK_IMPORTED_MODULE_0__[/* symbolTriangle */ "G"]).size(30));
                ...
                if (config.second_chart_type == "line") {
                  ...
                  var _xBar = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleBand */ "w"]().domain(dataset_two.map(function (d, i) {
                    return d.date;
                  })).range([0, width_first - margin.left - margin.right]).padding(0.05);
                ...
                var arr_text_two = [];
                var val_extent_two = d3__WEBPACK_IMPORTED_MODULE_0__[/* extent */ "k"](dataset_two, function (d, i) {
                  return d.value;
                });
        ...
        var parseTimeYear = d3__WEBPACK_IMPORTED_MODULE_0__[/* timeParse */ "I"]("%Y");
        var parseTimeSecond = d3__WEBPACK_IMPORTED_MODULE_0__[/* timeParse */ "I"]("%Y-%m-%d %H:%M:%S");
        var parseTime;
        ...
        var x = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleTime */ "B"]().range([0, 116]);
        var y = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleLinear */ "x"]().range([46, 0]);
        var y2 = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleLinear */ "x"]().range([46, 0]);
        ...
        var area = d3__WEBPACK_IMPORTED_MODULE_0__[/* area */ "a"]().x(function (d) {
          return x(parseTime(d.date));
        }).y0(function (d) {
          return y(0);
        }).y1(function (d) {
