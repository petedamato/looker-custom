(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["coloredBarsPerc"] = factory();
	else
		root["coloredBarsPerc"] = factory();
})(window, function() {
...
looker.plugins.visualizations.add({
  ...
  updateAsync: function updateAsync(data, element, config, queryResponse, details, done) {
    ...
    try {
      ...
      var group = svg.append("g").attr("transform", "translate(".concat(margin.left, ", ").concat(margin.top, ")")).attr("width", "100%").attr("height", height + "px").classed("group", true); // load the data
      ...
      data.forEach(function (d) {
        ...
        if (d[measure.name].value != 0 && parseTime(d[dimension.name].value) > parseTime("2021-12")) {
      ...
      console.log(data_ready); // scales

      var xScale = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleBand */ "w"]().domain(data_ready.map(function (d) {
        return groupAccessor(d);
      })).range([0, width]).padding(0.2);
      var yScale = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleLinear */ "x"]().domain([Math.min(0, d3__WEBPACK_IMPORTED_MODULE_0__[/* min */ "s"](data_ready, function (d) {
        return valueAccessor(d);
      })), d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "r"](data_ready, function (d) {
        return valueAccessor(d);
      ...
      if (config.bar_display == "no") {
        ...
        bars.attr("fill", function (d, i) {
          var thisChange = valueAccessor(d);
      ...
      var xAxisGenerator = d3__WEBPACK_IMPORTED_MODULE_0__[/* axisBottom */ "b"]().scale(xScale).tickSize(0).tickPadding([10]).tickFormat(d3__WEBPACK_IMPORTED_MODULE_0__[/* timeFormat */ "H"]("%b"));
      var xAxis = group.append("g").call(xAxisGenerator).style("transform", "translateY(".concat(height + 10, "px)")).attr("stroke-opacity", 0.0).attr("font-size", "1em").attr("font-family", "sans-serif"); // const yAxisGenerator = d3.axisLeft()
      //     .scale(yScale)
      //     .tickSize(0)
      //     .ticks(8)
      //     .tickFormat((d)=>{
      ...
      if (queryResponse.fields.dimensions.length != 1 || queryResponse.fields.measures.length < 1) {
        this.addError({
          ...
          message: "This chart takes 1 dimension and 1 measure."
        });
        return;
      }
