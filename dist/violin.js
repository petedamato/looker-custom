...
looker.plugins.visualizations.add({
  ...
  updateAsync: function updateAsync(data, element, config, queryResponse, details, done) {
    ...
    try {
      ...
      var group = svg.append('g').attr('transform', "translate(".concat(margin.left, ", ").concat(margin.top, ")")).attr('width', "100%").attr('height', height + "px").classed("group", true); // Get the shape of the data, this chart can take two dimensions or a pivot on the shorter dimension
      ...
      var parseTime = d3__WEBPACK_IMPORTED_MODULE_0__[/* timeParse */ "I"](dateDict[pivotDate]);
      console.log("dimensions, measures, pivots", dimensions, measure, pivots);
      var data_ready = [];
      var pivot_name = pivots[0].name;
      var pivot_column_labels = queryResponse.pivots;
      ...
      if (pivots[0].time_interval) {
        ...
        if (pivotSort) {
          data_ready.sort(function (a, b) {
            return b.group > a.group ? 1 : a.group > b.group ? -1 : 0;
          });
        } else {
          data_ready.sort(function (a, b) {
      ...
      console.log("data ready sorted", data_ready); // Clear any errors from previous updates
      // this.clearErrors();
      ...
      var xScale = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleBand */ "w"]().domain(buckets.range).range([0, width]).padding(0.05);
      var yScale = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleLinear */ "x"]().domain(d3__WEBPACK_IMPORTED_MODULE_0__[/* extent */ "k"](data_ready, function (d) {
        return d.value;
      ...
      var binsGenerator = d3__WEBPACK_IMPORTED_MODULE_0__[/* histogram */ "n"]().domain(yScale.domain()).value(function (d) {
        return d;
      }).thresholds(+config.thresholds);
      var groupBins = d3__WEBPACK_IMPORTED_MODULE_0__[/* nest */ "u"]().key(function (d) {
        return d.group;
      }).rollup(function (r) {
      ...
      var maxNum = 0;
      groupBins.forEach(function (value, key) {
        var findLengthFrom = value.value;
        var flat = value.value.flat();
        value["mean"] = flat.reduce(function (acc, c) {
          return acc + c;
        }, 0) / flat.length;
        ...
        var longest = d3__WEBPACK_IMPORTED_MODULE_0__[/* max */ "r"](lengths);
      ...
      if (config.unpin_y == true) {
        yScale.domain([d3__WEBPACK_IMPORTED_MODULE_0__[/* min */ "s"](data_ready, function (d) {
          return d.value;
        }), yMax]);
      } else {
      ...
      var xNum = d3__WEBPACK_IMPORTED_MODULE_0__[/* scaleLinear */ "x"]().domain([-maxNum, maxNum]).range([0, xScale.bandwidth()]); // -------------------------------------------------------
      // DRAW PERIPHERALS

      var xAxisGenerator = d3__WEBPACK_IMPORTED_MODULE_0__[/* axisBottom */ "b"]().scale(xScale).tickPadding(10); // x ticklabels

      if (config.xticklabels_show == true) {
        if (pivotDate) {
          console.log("xticklabels & pivotDate is true", config.xticklabel_format);
          xAxisGenerator.tickFormat(d3__WEBPACK_IMPORTED_MODULE_0__[/* timeFormat */ "H"](config.xticklabel_format));
        } else {
      ...
      var xAxis = group.append("g").call(xAxisGenerator).style("transform", "translateY(".concat(height, "px)")).attr("class", "x-axis").style("font-family", "Roboto");

      if (config.xticklabels_show == false) {
        d3__WEBPACK_IMPORTED_MODULE_0__[/* selectAll */ "D"](".x-axis text").attr("class", "hide");
      }

      if (config.x_gridlines == false) {
        d3__WEBPACK_IMPORTED_MODULE_0__[/* selectAll */ "D"](".x-axis line").attr("class", "hide");
      }

      var yAxisGenerator = d3__WEBPACK_IMPORTED_MODULE_0__[/* axisLeft */ "c"]().scale(yScale).tickPadding(10); // y ticklabels

      if (config.yticklabels_show == true) {
        yAxisGenerator.tickFormat(d3__WEBPACK_IMPORTED_MODULE_0__[/* format */ "l"](config.yticklabel_format));
      } else {
      ...
      var yAxis = group.append("g").call(yAxisGenerator).attr("class", "y-axis").style("font-family", "Roboto");

      if (config.yticklabels_show == false) {
        d3__WEBPACK_IMPORTED_MODULE_0__[/* selectAll */ "D"](".y-axis text").attr("class", "hide");
      }

      if (config.y_gridlines == false) {
        d3__WEBPACK_IMPORTED_MODULE_0__[/* selectAll */ "D"](".y-axis line").attr("class", "hide");
      } // AXIS LABELS


      if (config.show_xaxis_name == true) {
        var xAxisLabel = xAxis.append("text").attr("class", "axis-label").attr("x", width / 2).attr("y", margin.bottom - 8).text(function () {
      ...
      if (config.show_yaxis_name == true) {
        var yAxisLabel = yAxis.append("text").attr("class", "axis-label").attr("x", -height / 2).attr("y", -margin.left + 18).style("transform", "rotate(-90deg)").text(function () {
      ...
      }).attr("class", "violin").style("fill", config.colors).append("path").datum(function (d) {
        return d.value;
      }).style("stroke", "none").attr("d", d3__WEBPACK_IMPORTED_MODULE_0__[/* area */ "a"]().x0(function (d) {
        return xNum(-d.length);
      }).x1(function (d) {
        return xNum(d.length);
      }).y(function (d) {
        return yScale(d.x0);
      }).curve(d3__WEBPACK_IMPORTED_MODULE_0__[/* curveCatmullRom */ "f"])).attr("clip-path", "url(#plot-area)");
      var stats_marker = group.selectAll(".rect").data(groupBins).enter().append("g").attr("transform", function (d) {
        return "translate(" + xScale(d.key) + " ,0)";
      }).attr("class", "rect").append("rect").attr("x", xScale.bandwidth() / 4).attr("y", function (d) {
        return yScale(d[config.statistics]);
      }).attr("width", xScale.bandwidth() / 2).attr("height", 1.75).attr("stroke", function (d) {
