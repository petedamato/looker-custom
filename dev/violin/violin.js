d3.json("http://localhost:3001/dataViolin").then(function(loadin) {
    ...
    //   try {
          ...
          const width = widthPre - margin.left - margin.right;
          const height = heightPre - margin.top - margin.bottom; 
          ...
          const pivots = loadin.queryResponse.fields.pivots
